...
class Ui_ChooseMethod(object):
    ...
    def retranslateUi(self):
        ...
        self.methodComboBox.setItemText(0, _translate("ChooseMethod", "Gaussian-elimination"))
        self.methodComboBox.setItemText(1, _translate("ChooseMethod", "Gaussian-Jordan"))
        self.methodComboBox.setItemText(2, _translate("ChooseMethod", "Gaussian-Seidel"))
